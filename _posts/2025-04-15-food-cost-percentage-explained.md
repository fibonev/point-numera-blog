---
layout: post
title: "Food Cost Percentage: What the Number Is Actually Telling You"
date: 2025-04-15
author: Filip Bonev
category: restaurant
...
{% include callout.html type="insight" text="A restaurant running mains at €14-€22 with a blended food cost of 32% can easily have individual dishes ranging from 22% to 48% food cost. The average looks fine. The mix is the problem." %}
...
{% include pullquote.html text="The number that matters is not your food cost percentage. It is your contribution per cover — how much margin each guest actually leaves behind." %}
